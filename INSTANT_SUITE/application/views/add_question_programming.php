          ...
          <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-file-text-o"></i>Programming</li>
                    </ol>
                </div>
            </div>
                  ...
                  <div class="col-lg-6">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" action="<?php echo base_url()."index.php/teachers/bankQuestion/". 7 ?>" method="post" role="form" id="form2">
                                    <!-- Category -->    
