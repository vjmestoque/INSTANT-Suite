      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li>                     
                      <a class="" href="admin_view_logs.html">
                  ...
                  <li class="sub-menu">
                      <a href="admin_view_all_accounts.html" class="">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-th-list"></i>View All Acounts</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 ...
                                 <th><i class="icon_calendar"></i> Employee No</th>
